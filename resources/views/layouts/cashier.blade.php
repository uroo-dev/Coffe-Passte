...
<head>
    ...
    <title>@yield('title', 'Kasir - Coffe Paste')</title>
        ...
        setInterval(() => {
            fetch('/staff/pending-requests')
                ...
                .then(data => {
                    ...
                    if (count > prevRequestCount && prevRequestCount > 0) {
                    ...
                    if (badge) {
                        ...
                        badge.className = 'ml-auto px-2 py-0.5 text-[10px] font-bold rounded-full ' +
                            (count > 0 ? 'bg-red-500 text-white pulse-dot' : 'bg-primary-container/20 text-primary-container');
                    }
                })
                .catch(() => {});
        }, 5000);
